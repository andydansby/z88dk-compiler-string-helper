namespace z88dk_compile_options_helper_beta
{
	partial class compiler_choice
	{
		...
		private void InitializeComponent()
		{
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(269, 33);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(75, 23);
			this.button6.TabIndex = 119;
			this.button6.Text = "test zorg";
			this.button6.UseVisualStyleBackColor = true;
			this.button6.Click += new System.EventHandler(this.button6_Click);
			// 
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(263, 80);
			this.button7.Name = "button7";
			this.button7.Size = new System.Drawing.Size(105, 23);
			this.button7.TabIndex = 120;
			this.button7.Text = "test terminal driver";
			...
			this.button5.Text = "test optimization";
